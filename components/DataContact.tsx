...
const DataContact: React.FC<DataContactProps> = ({ lastName, reservationNumber }) => {
    ...
    return (
        <>
            ...
            {
                !showDataCard ? (<div
                    className="flex flex-col justify-center text-black items-center h-full bg-white data-container">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex flex-row gap-2'>
                                    <div className="mb-4 relative">
                                        <p className="text-black text-sm mb-2">Nombre completo del contacto de
                                            emergencia*</p>
                                    ...
                                    <div className="mb-4 relative">
                                        <p className="text-black text-sm mb-2">Número de teléfono del contacto de
                                            emergencia*</p>
                    ...
                    <Card lastName={lastName} reservationNumber={reservationNumber}/>)
            }
        </>
